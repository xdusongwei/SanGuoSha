...
using SGS.ServerCore.Contest.Apusic;
...
namespace SGS.ServerCore.Contest.Data
{
    ...
    public class Player
    {
        ...
        public void UnloadWeapon(GlobalEvent aObj, GlobalData aData)
        {
            if (Weapon != null)
            {
                SGS.ServerCore.Contest.Equipage.Weapon.UnloadWeapon(Weapon.CardEffect, aData);
                Weapon = null;
                foreach (ASkill s in Chief.Skills)
                    s.WeaponUpdated(Chief, Weapon, aData);
            }
        ...
        public void UnloadArmor(GlobalEvent aObj)
        {
            if (Armor != null)
            {
                SGS.ServerCore.Contest.Equipage.Armor.OnUnloadAromor(Armor.CardEffect, aObj.gData);
                Armor = null;
            }
        }
