        ...
        private Card[] IDs2Cards(int[] aIDs, Player aPlayer)
        {
            ...
            if (Game.WaittingData.Target == null)
            {
                foreach (int i in aIDs)
                {
                    ...
                    {
                        ret.Add(CardHeap.HeiTao);
                        continue;
                    }
                    else if (i == -2)
                    {
                        ret.Add(CardHeap.CaoHua);
                        continue;
                    }
                    else if (i == -3)
                    {
                        ret.Add(CardHeap.HongTao);
                        continue;
                    }
                    else if (i == -4)
                    {
                        ret.Add(CardHeap.FangPian);
                        continue;
                    }
                    ...
                    switch (Game.WaittingData.AskFor)
                    {
                        ...
                        case MessageCore.AskForEnum.Aggressive:
                            ...
                            else if (aCards.Count() != 1)
                            {
                                ...
                                {
                                    SGS.ServerCore.Contest.Equipage.Weapon.LeadCards(ThisPlayer.Weapon.CardEffect, aCards, ThisPlayer.Chief, Player.Players2Chiefs(Targets) , MessageCore.AskForEnum.Aggressive, ref Game.Response.Effect, Game.gData);
                                }
                            }
                        ...
                        default:
                            ...
                            {
                                SGS.ServerCore.Contest.Equipage.Weapon.LeadCards(ThisPlayer.Weapon.CardEffect, aCards, ThisPlayer.Chief, Player.Players2Chiefs(Targets), Game.WaittingData.AskFor, ref Game.Response.Effect, Game.gData);
                            }
                            break;
                    } //switch
