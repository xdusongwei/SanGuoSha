...
namespace SGS.ServerCore.Contest.Global
{
    ...
    public class MessageCore
    {
        ...
        public void SendMessage(Player[] aPlayers, string aMessage, bool aCommon)
        {
            ...
            //写日志
            string file = System.AppDomain.CurrentDomain.BaseDirectory + string.Format("TID{0}_{1:D2}H{2:D2}M{3:D2}S.txt", Thread.CurrentContext.ContextID.ToString(), _dtCreate.Hour, _dtCreate.Minute, _dtCreate.Second);
