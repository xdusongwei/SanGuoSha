...
{
    public class BingLiangCunDuanCase
    {
        [Fact]
        ...
        {   
            {
                var battlefield = new GameDebug(
                    aCards: [
                        new Card(1, Card.Suit.Heart, 1, CardEffect.兵粮寸断),
                    ],
                    aActions: [
                        (aa) => aa.Answer(
                            aUID: "A",
        ...
        {   
            {
                ...
                Assert.False(battlefield.ActionPlayerData.Take);
            }
            {
                var battlefield = new GameDebug(
                    aCards: [
                        new Card(1, Card.Suit.Heart, 1, CardEffect.兵粮寸断),
                        new Card(2, Card.Suit.Club, 2, CardEffect.杀),
                    ],
                    aActions: [
                        (aa) => aa.Answer(
                            aUID: "A",
                ...
                battlefield.LogicLoop(playerA, true);
                Assert.Empty(playerB.Debuff);
                Assert.True(battlefield.ActionPlayerData.Take);
            }
            {
                var battlefield = new GameDebug(
                    aCards: [
